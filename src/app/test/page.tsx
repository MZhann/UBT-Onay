          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="col-span-1 p-4 border-l">
                ...
                <Button className="w-full mt-6" onClick={handleCompleteTest}>
                  Complete
                </Button>
              </div>
            </div>
...
//             </div>
//             <DialogFooter>
//               <Button onClick={() => router.push("/unt-tests")}>Close</Button>
//             </DialogFooter>
//           </DialogContent>
//         </Dialog>
//       )}
